...
export const SaveListModal: FC<SaveListModalProps> = ({ open, onClose, formType }) => {
    ...
    const handleDownload = (id: string) => {
        const blob = new Blob([JSON.stringify(saves[id], null, 2)], { type: 'application/json' });  
                ...
                {Object.entries(saves)
                    ...
                    <TableRow key={id}>
                        ...
                        <TableCell align="right">
                            <IconButton onClick={() => handleEdit(id)}><Edit /></IconButton>
                            <IconButton onClick={() => handleDownload(id)}><Download /></IconButton>
